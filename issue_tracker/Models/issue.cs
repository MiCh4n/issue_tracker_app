...
namespace issue_tracker.Models
{
    ...
    {
        [DefaultValue("User")] public override string Name { get; set; }
    }
    ...
    public class Issue
    {
        ...
        [ForeignKey("AuthorId")] public virtual ApplicationUser ApplicationUserAuthorId { get; set; }
        public string AuthorId { get; set; }

        [ForeignKey("ReviewerId")] public virtual ApplicationUser ApplicationUserReviewer { get; set; }
